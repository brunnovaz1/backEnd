...
describe("Teste da API Produtos", function() {
    ...
    test("GET / deve retornar 200 um objeto JSON", async function() {   
    ...
    test("GET / id deve retornar 422 um objeto JSON", async function() {   
    ...
    test("PUT / id deve retornar 200 um objeto JSON", async function() {   
        const atual = { nome: "uva globo", preco: 20 };
